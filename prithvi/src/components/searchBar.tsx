            ...
            {focusBox && (
                <div className="bg-white px-4 py-4 absolute top-[2.4rem] left-0 w-full text-[12px] border-t-[1px] border-t-black search_drop_shadow rounded-br-md rounded-bl-md">
                    ...
                    <div className="my-4 flex items-center gap-2 flex-wrap">
                        ...
                        <p className="bg-[#F6F6F6] rounded-lg px-2 py-1">Noida</p>
                        <p className="bg-[#F6F6F6] rounded-lg px-2 py-1">Mumbai</p>
                        <p className="bg-[#F6F6F6] rounded-lg px-2 py-1">Patna</p>
                        <p className="bg-[#F6F6F6] rounded-lg px-2 py-1">Bangalore</p>
                        <p className="bg-[#F6F6F6] rounded-lg px-2 py-1">Hyderabad</p>
                    </div>
                </div>
            )}
        </div>
